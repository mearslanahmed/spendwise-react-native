      ...
      <View style={styles.container}>
              ...
              {unreadCount > 0 && (
                <View
                  style={[
                    ...
                    { borderColor: themeColors.inputBg, borderWidth: 2 },
                  ]}
                />
              )}
            </TouchableOpacity>
        ...
        <View style={styles.scrollViewStyle}>
          <TransactionList
            ...
            onEmptyClick={() =>
              wallets.length === 0
                ? router.push("/(modals)/walletModal" as any)
                  ...
                  <View style={styles.warningsSection}>
                    ...
                    >
                      {warningBudgets.map((b) => {
                        ...
                        const IconComponent =
                          categoryData?.icon || Icons.QuestionIcon;
                        const isExceeded = b.percent >= 100;
                        const cardBorderColor = isExceeded
                          ? colors.rose
                          : "#f97316";
                          ...
                          >
                            <View style={styles.warningCardHeader}>
                              ...
                              <View style={{ flex: 1 }}>
                                ...
                                <Typo
                                  size={11}
                                  color={isExceeded ? colors.rose : "#f97316"}
                                  fontWeight="500"
                                >
                            ...
                            <View style={styles.warningCardProgressRow}>
                              ...
                              <Typo size={12} fontWeight="500">
                                {user.currency || "$"}
                                {b.spent.toFixed(0)} / {user.currency || "$"}
                                {b.amount.toFixed(0)}
                              </Typo>
                            </View>
                            ...
                            <View
                              style={[
                                styles.cardProgressBarContainer,
                                { backgroundColor: themeColors.inputBg },
                              ]}
                            >
                              <View
